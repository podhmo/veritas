...
func run(pass *codegen.Pass) error {
	...
	if err != nil {
		// HACK: This is a workaround for the "chicken and egg" problem.
		// If the error is about an undefined function, we ignore it and continue.
		// This is because the function (e.g. GetKnownTypes) is generated by this tool.
		if strings.Contains(err.Error(), "undefined:") {
			logger.Warn("ignored 'undefined' error during initial parse, this is expected in 'chicken and egg' scenarios", "error", err)
		} else {
